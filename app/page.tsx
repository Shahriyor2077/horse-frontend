                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {recentPosts.length > 0 ? (
                        ...
                        <div className="text-center py-12 bg-white dark:bg-slate-800 rounded-2xl border border-dashed border-slate-300 dark:border-slate-600">
                            <FileText className="w-14 h-14 mx-auto mb-3 text-slate-300 dark:text-slate-600" />
                            <p className="text-slate-500 dark:text-slate-400">Tez orada qiziqarli maqolalar paydo bo'ladi</p>
                        </div>
                    )}
